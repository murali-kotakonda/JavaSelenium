...
public class CssEx  extends BaseTest{
	...
	public void t1() {
		...
		driver.findElement(By.cssSelector("a[href='https://www.gmail.com']")).click();
		sleep(3);
	...
	public void t2() {
		//<label id='error'>Enter values here</label>  <br/>
		WebElement labelObj = driver.findElement(By.cssSelector("label[id='error']"));
		Assert.assertEquals(labelObj.getText(), "Enter values here");
		
		driver.findElement(By.cssSelector("input[id='error']")).sendKeys("selenium");
		sleep(4);
	}
   ...
   */
	@Test
	public void t4() {
		List<WebElement> list = driver.findElements(By.cssSelector("p.show"));
